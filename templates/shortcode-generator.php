    ...
    <table class="wlkatalogsettingstabell">
      <tr>
        ...
        <td>
          ...
          <label for="resource-1">
            <?php _e('Biblioteket' , 'inter-library-search-by-webloft'); ?><br/>
          </label>
      ...
      <tr>
        <td>
          <label for="wl_katalogsok_option_mittbibliotek"><?php _e('Angi hvilken bibiliotekkatalog det skal s&oslash;kes i:', 'inter-library-search-by-webloft'); ?></label></td>
        <td>
